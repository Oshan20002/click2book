...
export default function Login() {
  return (
    <main>
      ...
      <h1 className="text-center mt-10 font-bold text-3xl ml-24" >Welcome Back</h1>
      <h2 className="text-center mt-5 font-bold text-2xl ml-24">Login</h2>
      <div className="w-1/3 mx-auto mt-5">
        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-10">
          ...
          <br />
          <br />
          <div className="flex gap-max justify-between">
          ...
          <button className="btn btn-neutral mt-4 w-full"><a href="Home">Login</a></button>
          ...
          <br />
          <p className="text-center"><u>Dont have an account? <b><a href="SignUp">  SignUp here</a></b></u></p>
        </fieldset>
      </div>
    </main>
  );
